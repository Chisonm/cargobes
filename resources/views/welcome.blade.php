...
@section('content')
        ...
        <div class="slider-area ">
            ...
            <div class="single-slider slider-height d-flex align-items-center" data-background="{{asset($append_ .'assets2/img/hero/parcelbox.jpg')}}" style="background-color: #9AD1ED;">
                    <div class="container">
                        <div class="row">
                                ...
                                <form action="{{ route('track_order') }}" method="get">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 mb-2">
                                             <input type="text" class="form-control pr-5 w-100" name="track_no" placeholder="Exp:car-564" required>
                                        </div>
                                        <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-tittle white-text text-center">
                            ...
                            <h2 style="color: #0091CD;"> How it works</h2>
                        </div>
                    </div>
                </div>
